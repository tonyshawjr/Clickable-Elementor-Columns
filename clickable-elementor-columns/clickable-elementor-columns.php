<?php
/**
 * Plugin Name:          Clickable Elementor Columns
...
class Clickable_Elementor_Columns {
  /**
   * Version.
   *
   * @var float
  ...
  public function includes() {
    // framework
    include_once 'includes/class-clickable-elementor-columns.php';
  }
...
add_action( 'plugins_loaded', array( 'Clickable_Elementor_Columns', 'get_instance' ) );
